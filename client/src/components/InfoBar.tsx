...
export default function InfoBar() {
  ...
  const { contactPhone: CONTACT_PHONE, contactEmail: CONTACT_EMAIL, contactHours: CONTACT_HOURS } = useSiteSettings()
    ...
    },
    {
      content: (
        <span style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ color: 'rgba(255,255,255,.6)' }}>&nbsp;·&nbsp; {CONTACT_HOURS || 'Haftaiçi 09:00–18:00'}</span>
        </span>
      ),
    },
    {
