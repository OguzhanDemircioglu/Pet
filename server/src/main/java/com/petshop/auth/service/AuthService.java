...
import com.petshop.auth.constant.AuthMessages;
...
import com.petshop.auth.service.JwtTokenProvider;
...
public class AuthService {
    ...
    public void register(RegisterRequest req) {
        ...
        User user = User.builder()
                ...
                .verificationCodeExpiresAt(LocalDateTime.now().plusMinutes(AuthSchedulerConstants.VERIFICATION_CODE_EXPIRY_MINUTES))
                .build();
    ...
    public void resendVerificationCode(String email) {
        ...
        user.setVerificationCodeExpiresAt(LocalDateTime.now().plusMinutes(AuthSchedulerConstants.VERIFICATION_CODE_EXPIRY_MINUTES));
        userRepository.save(user);

        try {
            notificationFacade.enqueueVerificationEmail(email, user.getFirstName(), code);
        } catch (Exception e) {
            log.error(AuthMessages.LOG_EMAIL_QUEUE_FAIL.get(), e.getMessage());
        }
    }
    ...
    public void requestEmailChange(Long userId, String newEmail) {
        ...
        notificationFacade.enqueueEmailChangeConfirmationEmail(newEmail.trim(), firstName, confirmUrl);
    }
