...
import com.offcats.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of(frontendUrl, "http://localhost:5173", "http://localhost:3000", "http://localhost:3333"));
